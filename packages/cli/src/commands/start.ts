...
const command: CommandModule = {
  ...
  handler: async argv => {
    ...
    const EventProvider = dappConfig.eventProvider ? require(dappConfig.eventProvider).default : undefined
    const eventProvider = EventProvider ? new EventProvider() : undefined
