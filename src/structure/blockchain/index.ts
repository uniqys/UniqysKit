...
export interface BlockStore {
  ...
  getLastConsensus (): Promise<Consensus>
  getHeader (height: number): Promise<BlockHeader>
  getBody (height: number): Promise<BlockBody>
  setHeight (height: number): Promise<void>
  setLastConsensus (consensus: Consensus): Promise<void>
  setHeader (height: number, header: BlockHeader): Promise<void>
  setBody (height: number, body: BlockBody): Promise<void>
}
