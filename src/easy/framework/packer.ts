...
import { URL } from 'url'
import { HttpHeaders, HttpRequest, HttpResponse } from '../structure/http-message'
import { Signature } from '../../structure/cryptography'
import { Transaction, SignedTransaction } from '../structure/transaction'
...
export namespace SignedRequest {
  export async function pack (request: http.IncomingMessage, to: URL): Promise<SignedTransaction> {
    ...
    const nonce = Number.parseInt(nonceString)
